"""
Supervised Pointer Network trainer for the simplified 5-city TSP demo.

Input:
- ../train/tsp_correct_5.txt
...
parser=argparse.ArgumentParser(description="Basic Pointer Network trainer for the simplified project.")
...
RESULT_FILE = args['result_file'] or "../result/" + str(SEQ_LEN) + "result.txt"
